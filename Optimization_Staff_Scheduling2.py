...
def Optimization_Staff_Scheduling2(
    ...
    for i in employees:
        ...
        total_weekend = dict_employees[i].get("prev_weekend_shifts", 0) + current_weekend  # 🔥 fix
